		...
		public void getMenuClick(View v ){
			...
			v.setOnClickListener(new View.OnClickListener() {
				...
				public void onClick(View v) {
					...
					else if(v==systemsettings)
						GlobalVars.activityItemLocation=10;
					else
						GlobalVars.activityItemLocation=12;
